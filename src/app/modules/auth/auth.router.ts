...
import { changePasswordController, forgetPasswordController, getMyProfileController, signInController, updateProfileController, verifyOtpController } from "./auth.controller";
